...
export const mock_posts = [
    {
        ...
        image: [
            baseImage('https://miro.medium.com/max/560/1*wDnkkuycuVXGEu5WH8SxGg.jpeg', 'Imagem de uma mulher comemorando em frente ao notebook', 'Mulher comemorando' )
        ],
        content: `
        <p>
    ...
    },
    {
        ...
        image: [
            {
                src: 'https://www.docker.com/wp-content/uploads/2021/09/Docker-build.png', alt: 'Ilustração de um polvo e uma baleia brincando com conteiners', title: 'Ilustração do Docker', 
            }
        ],
    ...
    },
    {
        ...
        image: [
            {
                src: 'https://www.axdata.sk/img/cms/ako-vybrat-notebook/ako-vybrat-notebook.jpg', alt: 'Ilustração de um notebook semi aberto', title: 'Ilustração de um notebook', 
            }
        ],
        content: `Mussum Ipsum, cacilds vidis litro abertis. Posuere libero varius. Nullam a nisl ut ante blandit hendrerit. Aenean sit amet nisi.Leite de capivaris, leite de mula manquis sem cabeça.Quem num gosta di mim que vai caçá sua turmis!Interessantiss quisso pudia ce receita de bolis, mais bolis eu num gostis.
        Sapien in monti palavris qui num significa nadis i pareci latim.Copo furadis é disculpa de bebadis, arcu quam euismod magna.Leite de capivaris, leite de mula manquis sem cabeça.Mé faiz elementum girarzis, nisi eros vermeio.
    ...
    },
    {
        ...
        image: [
            {
                src: 'https://www.axdata.sk/img/cms/ako-vybrat-notebook/ako-vybrat-notebook.jpg', alt: 'Ilustração do logo da biblioteca Fast API', title: 'Ilustração do Fast API', 
            }
        ],
        content: `Mussum Ipsum, cacilds vidis litro abertis. Posuere libero varius. Nullam a nisl ut ante blandit hendrerit. Aenean sit amet nisi.Leite de capivaris, leite de mula manquis sem cabeça.Quem num gosta di mim que vai caçá sua turmis!Interessantiss quisso pudia ce receita de bolis, mais bolis eu num gostis.
        Sapien in monti palavris qui num significa nadis i pareci latim.Copo furadis é disculpa de bebadis, arcu quam euismod magna.Leite de capivaris, leite de mula manquis sem cabeça.Mé faiz elementum girarzis, nisi eros vermeio.
